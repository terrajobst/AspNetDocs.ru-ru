...
title: Веб-форм ASP.NET и Ajax 4 | Документация Майкрософт
...
ms.locfileid: "59419955"
---
# <a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="b69c0-102">Веб-формы ASP.NET и Ajax 4</span><span class="sxs-lookup"><span data-stu-id="b69c0-102">ASP.NET Web Forms and Ajax 4</span></span>

<span data-ttu-id="b69c0-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="b69c0-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="b69c0-104">Примечание. Сценарии глобализации, например, fr-FR.js, можно найти в следующей папке:</span><span class="sxs-lookup"><span data-stu-id="b69c0-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
