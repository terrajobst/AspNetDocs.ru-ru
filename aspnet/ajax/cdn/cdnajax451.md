...
title: ASP.NET Web Forms и AJAX 4.5.1 | Документация Майкрософт
...
ms.locfileid: "78454176"
---
# <a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="f9a02-102">Веб-формы ASP.NET и Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="f9a02-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>

<span data-ttu-id="f9a02-103">Следующие файлы размещаются в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="f9a02-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="f9a02-104">Примечание. скрипты глобализации, такие как фр-фр. js, можно найти в следующей папке:</span><span class="sxs-lookup"><span data-stu-id="f9a02-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
