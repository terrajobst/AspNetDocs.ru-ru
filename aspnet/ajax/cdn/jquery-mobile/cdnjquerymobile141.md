...
title: jQuery Mobile 1.4.1 в сети доставки Содержимого Microsoft Ajax | Документация Майкрософт
...
ms.locfileid: "57035351"
---
<a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="143bf-102">jQuery Mobile 1.4.1 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="143bf-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="143bf-103">Библиотека jQuery Mobile 1.4.1 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="143bf-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
