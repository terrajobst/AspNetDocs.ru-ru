...
ms.locfileid: "59394111"
---
# <a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="7f1a4-102">jQuery Mobile 1.4.1 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="7f1a4-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="7f1a4-103">Библиотека jQuery Mobile 1.4.1 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="7f1a4-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
