...
ms.locfileid: "57043181"
---
<a name="jquery-mobile-120-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="c47d7-102">jQuery Mobile 1.2.0 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="c47d7-102">jQuery Mobile 1.2.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="c47d7-103">Библиотека jQuery Mobile 1.2.0 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="c47d7-103">The jQuery Mobile 1.2.0 library includes the following files:</span></span>
