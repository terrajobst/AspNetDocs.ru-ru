...
title: jQuery Mobile 1.4.0 в сети доставки Содержимого Microsoft Ajax | Документация Майкрософт
...
---
# <a name="jquery-mobile-140-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="82850-102">jQuery Mobile 1.4.0 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="82850-102">jQuery Mobile 1.4.0 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="82850-103">Библиотека jQuery Mobile 1.4.0 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="82850-103">The jQuery Mobile 1.4.0 library includes the following files:</span></span>
