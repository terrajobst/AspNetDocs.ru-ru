...
ms.locfileid: "57034031"
---
<a name="jquery-mobile-101-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="79954-102">jQuery Mobile 1.0.1 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="79954-102">jQuery Mobile 1.0.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="79954-103">Библиотека jQuery Mobile 1.0.1 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="79954-103">The jQuery Mobile 1.0.1 library includes the following files:</span></span>
