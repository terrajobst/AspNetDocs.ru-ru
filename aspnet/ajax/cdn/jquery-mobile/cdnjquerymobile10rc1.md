...
---
# <a name="jquery-mobile-10-rc1-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="ed688-102">jQuery Mobile 1.0 RC1 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="ed688-102">jQuery Mobile 1.0 RC1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="ed688-103">Библиотека jQuery Mobile 1.0 версии-Кандидата 1 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="ed688-103">The jQuery Mobile 1.0 RC 1 library includes the following files:</span></span>
