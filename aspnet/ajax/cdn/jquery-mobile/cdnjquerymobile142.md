...
title: jQuery Mobile 1.4.2 в сети доставки Содержимого Microsoft Ajax | Документация Майкрософт
...
ms.locfileid: "57030701"
---
<a name="jquery-mobile-142-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="f96f4-102">jQuery Mobile 1.4.2 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="f96f4-102">jQuery Mobile 1.4.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="f96f4-103">Библиотека jQuery Mobile 1.4.2 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="f96f4-103">The jQuery Mobile 1.4.2 library includes the following files:</span></span>
