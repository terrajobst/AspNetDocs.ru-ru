...
ms.locfileid: "57048291"
---
<a name="jquery-mobile-111-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="66707-102">jQuery Mobile 1.1.1 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="66707-102">jQuery Mobile 1.1.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="66707-103">Библиотека jQuery Mobile 1.1.1 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="66707-103">The jQuery Mobile 1.1.1 library includes the following files:</span></span>
