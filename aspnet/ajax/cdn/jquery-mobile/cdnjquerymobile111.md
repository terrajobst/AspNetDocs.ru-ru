...
title: jQuery Mobile 1.1.1 в сети CDN Microsoft AJAX | Документация Майкрософт
...
ms.locfileid: "78453948"
---
# <a name="jquery-mobile-111-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="12ccc-102">jQuery Mobile 1.1.1 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="12ccc-102">jQuery Mobile 1.1.1 on the Microsoft Ajax CDN</span></span>

<span data-ttu-id="12ccc-103">Библиотека jQuery Mobile 1.1.1 содержит следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="12ccc-103">The jQuery Mobile 1.1.1 library includes the following files:</span></span>
