...
ms.locfileid: "57027741"
---
<a name="jquery-mobile-112-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="1192f-102">jQuery Mobile 1.1.2 в сети доставки содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="1192f-102">jQuery Mobile 1.1.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="1192f-103">Библиотека jQuery Mobile 1.1.2 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="1192f-103">The jQuery Mobile 1.1.2 library includes the following files:</span></span>
