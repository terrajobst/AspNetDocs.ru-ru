...
ms.locfileid: "78454134"
---
# <a name="jquery-datatables-1105"></a><span data-ttu-id="568d3-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="568d3-102">jQuery DataTables 1.10.5</span></span>

<span data-ttu-id="568d3-103">Следующие файлы для подключаемых модулей DataTables jQuery размещены в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="568d3-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
