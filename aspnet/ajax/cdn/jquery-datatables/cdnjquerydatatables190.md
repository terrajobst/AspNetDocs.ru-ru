...
ms.locfileid: "57049821"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="9ecea-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="9ecea-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="9ecea-103">Следующие файлы для jQuery DataTables подключаемые модули размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="9ecea-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
