...
ms.locfileid: "78454062"
---
# <a name="jquery-datatables-182"></a><span data-ttu-id="4673f-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="4673f-102">jQuery DataTables 1.8.2</span></span>

<span data-ttu-id="4673f-103">Следующие файлы для подключаемых модулей DataTables jQuery размещены в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="4673f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
