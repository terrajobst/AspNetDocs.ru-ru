...
ms.locfileid: "59411908"
---
# <a name="jquery-datatables-182"></a><span data-ttu-id="df2ea-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="df2ea-102">jQuery DataTables 1.8.2</span></span>

<span data-ttu-id="df2ea-103">Следующие файлы для jQuery DataTables подключаемые модули размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="df2ea-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
