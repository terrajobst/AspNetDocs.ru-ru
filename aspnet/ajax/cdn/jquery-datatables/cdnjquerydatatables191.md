...
ms.locfileid: "78454044"
---
# <a name="jquery-datatables-191"></a><span data-ttu-id="72870-102">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="72870-102">jQuery DataTables 1.9.1</span></span>

<span data-ttu-id="72870-103">Следующие файлы для подключаемых модулей DataTables jQuery размещены в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="72870-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
