...
---
# <a name="jquery-datatables-193"></a><span data-ttu-id="2a8e1-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="2a8e1-102">jQuery DataTables 1.9.3</span></span>

<span data-ttu-id="2a8e1-103">Следующие файлы для подключаемых модулей DataTables jQuery размещены в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="2a8e1-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
