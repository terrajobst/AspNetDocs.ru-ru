...
title: Веб-формы ASP.NET и AJAX 4.5.2 | Документация Майкрософт
...
ms.locfileid: "78454164"
---
# <a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="3ba50-102">Веб-формы ASP.NET и Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="3ba50-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>

<span data-ttu-id="3ba50-103">Следующие файлы размещаются в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="3ba50-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="3ba50-104">Примечание. скрипты глобализации, такие как фр-фр. js, можно найти в следующей папке:</span><span class="sxs-lookup"><span data-stu-id="3ba50-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
