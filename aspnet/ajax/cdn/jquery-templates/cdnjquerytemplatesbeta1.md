...
title: Шаблоны jQuery Beta 1 | Документация Майкрософт
...
ms.locfileid: "78453660"
---
# <a name="jquery-templates-beta-1"></a><span data-ttu-id="b5e11-102">jQuery Templates, бета-версия 1</span><span class="sxs-lookup"><span data-stu-id="b5e11-102">jQuery Templates Beta 1</span></span>

<span data-ttu-id="b5e11-103">Подключаемый модуль шаблонов jQuery содержит следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="b5e11-103">The jQuery Templates plugin includes the following files:</span></span>
