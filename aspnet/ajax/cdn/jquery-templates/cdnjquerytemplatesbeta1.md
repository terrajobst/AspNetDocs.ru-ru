...
---
# <a name="jquery-templates-beta-1"></a><span data-ttu-id="7efcd-102">jQuery Templates, бета-версия 1</span><span class="sxs-lookup"><span data-stu-id="7efcd-102">jQuery Templates Beta 1</span></span>

<span data-ttu-id="7efcd-103">Подключаемый модуль jQuery шаблонов включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="7efcd-103">The jQuery Templates plugin includes the following files:</span></span>
