...
ms.locfileid: "57030681"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="ae6a1-102">jQuery Templates, бета-версия 1</span><span class="sxs-lookup"><span data-stu-id="ae6a1-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="ae6a1-103">Подключаемый модуль jQuery шаблонов включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="ae6a1-103">The jQuery Templates plugin includes the following files:</span></span>
