...
ms.locfileid: "78472788"
---
# <a name="jqueryvalidate-version-19"></a><span data-ttu-id="3a6dd-102">jquery.validate версии 1.9</span><span class="sxs-lookup"><span data-stu-id="3a6dd-102">jquery.validate version 1.9</span></span>

<span data-ttu-id="3a6dd-103">Следующие файлы размещаются в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="3a6dd-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="3a6dd-104">Файлы локализации в https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js, где # # — это код Loc.</span><span class="sxs-lookup"><span data-stu-id="3a6dd-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
