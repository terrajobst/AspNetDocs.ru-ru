...
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="66954-102">jquery.validate версии 1.8</span><span class="sxs-lookup"><span data-stu-id="66954-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="66954-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="66954-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="66954-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js где ## — loc код.</span><span class="sxs-lookup"><span data-stu-id="66954-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
