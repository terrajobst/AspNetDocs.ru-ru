...
ms.locfileid: "59393162"
---
# <a name="jquery-validation-1120"></a><span data-ttu-id="e7b55-102">jQuery Validate 1.12.0</span><span class="sxs-lookup"><span data-stu-id="e7b55-102">jQuery Validation 1.12.0</span></span>

<span data-ttu-id="e7b55-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="e7b55-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="e7b55-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js где ## — loc код.</span><span class="sxs-lookup"><span data-stu-id="e7b55-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js where ## is the loc code.</span></span>
