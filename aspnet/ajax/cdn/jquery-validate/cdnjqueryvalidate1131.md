...
ms.locfileid: "59414989"
---
# <a name="jquery-validation-1131"></a><span data-ttu-id="23d52-102">jQuery Validation 1.13.1</span><span class="sxs-lookup"><span data-stu-id="23d52-102">jQuery Validation 1.13.1</span></span>

<span data-ttu-id="23d52-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="23d52-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="23d52-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/localization/messages\_##.js где ## — loc код.</span><span class="sxs-lookup"><span data-stu-id="23d52-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/localization/messages\_##.js where ## is the loc code.</span></span>
