...
title: jQuery Validate 1,6 | Документация Майкрософт
...
ms.locfileid: "78472812"
---
# <a name="jquery-validate-16"></a><span data-ttu-id="d083a-102">jQuery Validate 1.6</span><span class="sxs-lookup"><span data-stu-id="d083a-102">jQuery Validate 1.6</span></span>

<span data-ttu-id="d083a-103">Следующие файлы размещаются в сети CDN:</span><span class="sxs-lookup"><span data-stu-id="d083a-103">The following files are hosted on the CDN:</span></span>
