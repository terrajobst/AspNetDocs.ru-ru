...
ms.locfileid: "67471424"
---
# <a name="jquery-validation-1191"></a><span data-ttu-id="248b6-102">jQuery Validation 1.19.1</span><span class="sxs-lookup"><span data-stu-id="248b6-102">jQuery Validation 1.19.1</span></span>

<span data-ttu-id="248b6-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="248b6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="248b6-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.19.1/localization/messages\_##.js где ## — loc код.</span><span class="sxs-lookup"><span data-stu-id="248b6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.19.1/localization/messages\_##.js where ## is the loc code.</span></span>
