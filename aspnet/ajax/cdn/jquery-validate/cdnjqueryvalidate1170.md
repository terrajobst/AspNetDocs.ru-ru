...
---
# <a name="jquery-validation-1170"></a><span data-ttu-id="b78e1-102">jQuery Validation 1.17.0</span><span class="sxs-lookup"><span data-stu-id="b78e1-102">jQuery Validation 1.17.0</span></span>

<span data-ttu-id="b78e1-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="b78e1-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="b78e1-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js где ## — loc код.</span><span class="sxs-lookup"><span data-stu-id="b78e1-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
