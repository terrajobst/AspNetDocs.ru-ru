...
ms.locfileid: "57033961"
---
<a name="jquery-validate-155"></a><span data-ttu-id="aeec3-102">jQuery Validate 1.5.5</span><span class="sxs-lookup"><span data-stu-id="aeec3-102">jQuery Validate 1.5.5</span></span>
====================
<span data-ttu-id="aeec3-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="aeec3-103">The following files are hosted on the CDN:</span></span>
