...
- [Доступ к данным для масштабируемых решений: С помощью SQL, NoSQL и Polyglot Persistence](http://aka.ms/dag-doc). Электронная книга Microsoft Patterns and Practices подробно разбирает различные виды данных хранит доступны для облачных приложений.
