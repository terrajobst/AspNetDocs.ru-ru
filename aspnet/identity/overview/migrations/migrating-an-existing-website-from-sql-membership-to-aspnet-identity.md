...
3. Откройте файл web.config и измените строку подключения из. SQLExpess для v11.0 (LocalDb). Удалить "User Instance = true" в строке подключения.
...
1. Создать моделей в папку проекта и добавьте класс пользователя. Имя класса должно соответствовать данные, добавленные в столбце «Дискриминатора» таблицы «AspnetUsers».
