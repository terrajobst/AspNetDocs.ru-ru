...
| **идентитюсер** | **Type** | **идентитироле** | **идентитюсерроле** | **идентитюсерлогин** | **идентитюсерклаим** |
| --- | --- | --- | --- | --- | --- |
| Id | string | Id | RoleId | провидеркэй | Id |
| Имя пользователя | string | Name | UserId | UserId | ClaimType |
