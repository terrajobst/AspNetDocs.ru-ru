...
Visual Studio 2013 включает новые и улучшенные функции веб-публикации. Вот несколько из них:
...
### <a name="httprequestcontext"></a>хттпрекуестконтекст
...
Безопасность браузера предотвращает выполнение запросов AJAX к другому домену на веб-странице. [CORS](http://www.w3.org/TR/cors/) — это стандарт консорциума W3C, позволяющий серверу ослабить политику того же источника. С помощью CORS сервер может явно разрешить некоторые запросы между источниками, одновременно отклоняя другие.
