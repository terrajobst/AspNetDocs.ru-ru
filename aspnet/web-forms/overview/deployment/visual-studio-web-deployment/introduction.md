...
1. Сохранить файлы решения ContosoUniversity из C# папки в папку с именем ContosoUniversity в любую папку, используйте для работы с проектами Visual Studio.
