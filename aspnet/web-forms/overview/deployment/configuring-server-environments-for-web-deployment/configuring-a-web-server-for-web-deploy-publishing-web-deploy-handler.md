...
3. В верхней части окна **установщика веб-платформы** щелкните **Products (продукты**).
...
12. Нажмите кнопку **Установить**. Установщик веб-платформы отобразит список продуктов&#x2014;вместе со всеми связанными зависимостями&#x2014;, которые будут установлены, и предложит принять условия лицензионного соглашения.
...
| --- | --- | --- | --- |
| Трафика | Любая | 8172 | TCP |
| Ходящую | 8172 | Любая | TCP |
