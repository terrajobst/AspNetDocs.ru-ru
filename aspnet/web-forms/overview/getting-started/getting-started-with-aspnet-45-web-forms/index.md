...
title: Начало работы с веб-формами ASP.NET 4,5 и Visual Studio 2013 | Документация Майкрософт
author: rick-anderson
description: В этой серии руководств вы узнаете об основах создания приложения ASP.NET Web Forms с помощью ASP.NET 4,5 и Visual Studio 2013 Express для Web. Висуа...
ms.author: riande
ms.date: 04/09/2012
...
> В этой серии руководств вы узнаете об основах создания приложения ASP.NET Web Forms с помощью ASP.NET 4,5 и Microsoft Visual Studio Express 2013 для Web. Для этой серии руководств C# доступен проект Visual Studio 2013 с исходным кодом.
