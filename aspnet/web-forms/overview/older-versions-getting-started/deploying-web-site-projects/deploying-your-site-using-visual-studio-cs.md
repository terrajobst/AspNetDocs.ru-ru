...
ms.locfileid: "65133460"
---
# <a name="deploying-your-site-using-visual-studio-c"></a>Развертывание сайта с помощью Visual Studio (C#)

по [Скотт Митчелл](https://twitter.com/ScottOnWriting)

[Скачать код](http://download.microsoft.com/download/4/5/F/45F815EC-8B0E-46D3-9FB8-2DC015CCA306/ASPNET_Hosting_Tutorial_04_CS.zip) или [скачать PDF](http://download.microsoft.com/download/E/8/9/E8920AE6-D441-41A7-8A77-9EF8FF970D8B/aspnet_tutorial04_DeployingViaVS_cs.pdf)
...
Чтобы развертывание новых файлов, выделите их и затем щелкните значок со стрелкой для передачи их на удаленный сайт. После завершения передачи `Policy.aspx` и `Policy.aspx.cs` файлы существуют на локальных и удаленных узлах состояние Unchanged.
