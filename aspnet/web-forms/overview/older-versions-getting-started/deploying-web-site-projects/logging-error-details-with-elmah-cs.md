...
[Скачать код](https://download.microsoft.com/download/1/0/C/10CC829F-A808-4302-97D3-59989B8F9C01/ASPNET_Hosting_Tutorial_14_CS.zip) или [скачать PDF](https://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial14_ELMAH_cs.pdf)
...
В этом учебнике рассматриваются шаги, связанные с добавлением ELMAH в приложение ASP.NET. Приступим.
...
([Щелкните, чтобы просмотреть изображение с полным размером](logging-error-details-with-elmah-cs/_static/image7.png))
...
([Щелкните, чтобы просмотреть изображение с полным размером](logging-error-details-with-elmah-cs/_static/image10.png))
...
([Щелкните, чтобы просмотреть изображение с полным размером](logging-error-details-with-elmah-cs/_static/image13.png))
...
([Щелкните, чтобы просмотреть изображение с полным размером](logging-error-details-with-elmah-cs/_static/image16.png))
...
> [!NOTE]
> Роль администратора и три пользователя в системе (Скотт, Цзисунь и Алиса) были добавлены в окне [ *Настройка веб-сайта, использующего* учебник по службы приложений](configuring-a-website-that-uses-application-services-cs.md). Пользователи Скотт и Цзисунь являются членами роли администратора. Дополнительные сведения о проверке подлинности и авторизации см. в [руководствах по безопасности веб-сайтов](../../older-versions-security/introduction/security-basics-and-asp-net-support-cs.md).
...
([Щелкните, чтобы просмотреть изображение с полным размером](logging-error-details-with-elmah-cs/_static/image19.png))
...
([Щелкните, чтобы просмотреть изображение с полным размером](logging-error-details-with-elmah-cs/_static/image22.png))
