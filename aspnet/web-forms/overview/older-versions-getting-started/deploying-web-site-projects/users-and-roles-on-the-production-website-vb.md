...
ms.locfileid: "74617972"
---
# <a name="users-and-roles-on-the-production-website-vb"></a>Пользователи и роли на рабочем веб-сайте (VB)

по [Скотт Митчелл](https://twitter.com/ScottOnWriting)

[Загрузить PDF-файл](https://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial16_CustomAWAT_vb.pdf)
