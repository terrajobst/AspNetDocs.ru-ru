...
[Загрузить PDF-файл](https://download.microsoft.com/download/C/1/9/C19A3451-1D14-477C-B703-54EF22E197EE/AJAX_tutorial01_Partial_Page_Updates_cs.pdf)
...
| Асинкпостбаккеррор — сообщение | Строковое | Возвращает или задает сообщение об ошибке, отправляемое клиенту при возникновении ошибки. |
...
| ScriptPath | Строковое | Возвращает или задает корневой путь к расположению файлов скрипта, отправляемых клиенту. |
...
| &lt;Скрипты&gt; | Предоставляет дополнительные ссылки на скрипты. |
| &lt;ASP: ScriptReference&gt; | Обозначает определенную ссылку на скрипт. |
| &lt;Service&gt; | Предоставляет дополнительные ссылки на веб-службы, которые будут создаваться классами прокси. |
...
| контенттемплатеконтаинер | Элемент управления | Возвращает программный шаблон для запроса на обновление. |
...
| **Имя свойства** | **Type** | **Описание** |
| --- | --- | --- |
| АссоЦиатедупдате — Панелид | Строковое | Указывает идентификатор элемента UpdatePanel, по которому должен быть отчет UpdateProgress. |
