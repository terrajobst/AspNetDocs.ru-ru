...
[![Страница содержит три веб-элементов управления: текстовое поле, кнопку и метку](control-id-naming-in-content-pages-vb/_static/image4.png)](control-id-naming-in-content-pages-vb/_static/image3.png)
...
[![Вызывается исключение NullReferenceException](control-id-naming-in-content-pages-vb/_static/image8.png)](control-id-naming-in-content-pages-vb/_static/image7.png)
...
[![Методы расширения, включенные в IntelliSense раскрывающихся](control-id-naming-in-content-pages-vb/_static/image14.png)](control-id-naming-in-content-pages-vb/_static/image13.png)
...
- [Практическое руководство. Содержимое страницы руководство](https://msdn.microsoft.com/library/xxwa0ff0.aspx)
