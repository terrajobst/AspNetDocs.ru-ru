...
В **диспетчер файлов** выберите **contosouniversity.com** и затем **wwwrooot** в корневой папке приложения. Щелкните значок с изображением замка рядом **Elmah**.
