...
ms.locfileid: "65112866"
---
# <a name="security-authentication-and-authorization-in-aspnet-web-forms"></a><span data-ttu-id="bd2b6-103">Безопасность, проверка подлинности и авторизация в веб-форм ASP.NET</span><span class="sxs-lookup"><span data-stu-id="bd2b6-103">Security, Authentication, and Authorization in ASP.NET Web Forms</span></span>
