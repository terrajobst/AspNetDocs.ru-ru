...
ASP.NET 2.0 – это значительное улучшение в области, персонализированных веб-сайтов. В дополнение к возможности членства, которые мы уже рассмотрели профили ASP.NET, темы и веб-частей значительно улучшить персонализации в веб-сайтов.
