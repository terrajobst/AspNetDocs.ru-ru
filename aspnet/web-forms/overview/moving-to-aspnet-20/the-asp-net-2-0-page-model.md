...
|      <strong>Метода GetWebResourceUrl</strong>       | Возвращает URL-адрес ресурса, внедренного в сборку. Необходимо использовать в сочетании с <strong>RegisterClientScriptResource</strong>. |
