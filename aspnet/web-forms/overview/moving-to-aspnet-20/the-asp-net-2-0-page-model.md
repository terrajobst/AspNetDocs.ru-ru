...
Это свойство возвращает уникальный suffic, добавляемый в путь к файлу для кэширования браузеров. Значение по умолчанию — \_ \_ufps = и число из 6 цифр.
