...
При желании можно изменить сведения о соответствии XHML по умолчанию через узел xhtmlConformance в файле конфигурации. Например следующий узел в файле web.config изменится XHTML-совместимость XHTML 1.0 Strict:
