...
## <a name="polling-based-sql-cache-dependenciesemalso-called-table-based-dependenciesem"></a>На основе опроса зависимости кэша SQL<em>(также называемый зависимости на основе таблицы)</em>
...
| **Элемент** | **Описание** |
| --- | --- |
| **cache** | Необязательный элемент. Определяет параметры кэша глобальных приложений. |
...
| **Attribute (XElement Dynamic Property)** (Attribute (динамическое свойство XElement)) | **Описание** |
| --- | --- |
| **включен** | Требуется **логическое** атрибута. Указывает, являются ли изменения выполняется опрос на наличие. |
