...
[![Добавление элемента управления Sectionleveltutoriallisting.ascx к странице Default.aspx](uploading-files-cs/_static/image2.gif)](uploading-files-cs/_static/image1.png)
...
[![Добавить столбец BrochurePath в таблицу Categories](uploading-files-cs/_static/image5.gif)](uploading-files-cs/_static/image5.png)
...
[![Обновление списка столбцов в инструкции SELECT инструкции также вернет значение BrochurePath](uploading-files-cs/_static/image7.gif)](uploading-files-cs/_static/image9.png)
...
[![Выберите параметр использовать SQL-инструкции](uploading-files-cs/_static/image8.gif)](uploading-files-cs/_static/image11.png)
...
[![Так как запрос вернет записи из таблицы Categories, выбор SELECT, возвращающая строки](uploading-files-cs/_static/image9.gif)](uploading-files-cs/_static/image13.png)
...
[![Выберите имена для методов класса TableAdapter s](uploading-files-cs/_static/image10.gif)](uploading-files-cs/_static/image15.png)
...
[![Добавление элемента управления FileUpload страницы ASP.NET](uploading-files-cs/_static/image12.gif)](uploading-files-cs/_static/image17.png)
...
[![Пользователь может выбрать файл для передачи со своего компьютера к серверу](uploading-files-cs/_static/image13.gif)](uploading-files-cs/_static/image19.png)
...
[![Файл EvolutionValley.jpg будут переданы на веб-сервер](uploading-files-cs/_static/image14.gif)](uploading-files-cs/_static/image21.png)
