...
[Скачайте пример приложения](http://download.microsoft.com/download/4/a/7/4a7a3b18-d80e-4014-8e53-a6a2427f0d93/ASPNET_Data_Tutorial_54_CS.exe) или [скачать PDF](uploading-files-cs/_static/datatutorial54cs1.pdf)
...
[![Aдд пользовательского элемента управления SectionLevelTutorialListing.ascx к странице Default.aspx](uploading-files-cs/_static/image2.gif)](uploading-files-cs/_static/image1.png)

**Рис. 2**: Добавить `SectionLevelTutorialListing.ascx` для пользовательского элемента управления `Default.aspx` ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image2.png))
...
[![Bвоичные данные могут храниться в файловой системе или непосредственно в базе данных](uploading-files-cs/_static/image4.gif)](uploading-files-cs/_static/image3.png)

**Рис. 4**: Двоичные данные могут храниться в файловой системе или непосредственно в базе данных ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image4.png))
...
[![Aдд BrochurePath столбец в таблицу Categories](uploading-files-cs/_static/image5.gif)](uploading-files-cs/_static/image5.png)

**Рис. 5**: Добавить `BrochurePath` столбец `Categories` таблицы ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image6.png))
...
[![CСоздание рисунка DataColumn с именем, типом данных является System.Byte []](uploading-files-cs/_static/image6.gif)](uploading-files-cs/_static/image7.png)
...
[![UОбновить список столбцов в инструкции SELECT, чтобы также возвращают BrochurePath](uploading-files-cs/_static/image7.gif)](uploading-files-cs/_static/image9.png)

**Рис. 7**: Обновление списка столбцов в `SELECT` инструкция также возвращает `BrochurePath` ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image10.png))
...
[![Sвыбрать использовать инструкции SQL параметр](uploading-files-cs/_static/image8.gif)](uploading-files-cs/_static/image11.png)

**Рис. 8**: Выберите инструкции SQL используйте параметр ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image12.png))


[![Sинс запрос вернет записи из таблицы Categories, выберите выбрать, какие возвращает строки](uploading-files-cs/_static/image9.gif)](uploading-files-cs/_static/image13.png)

**Рис. 9**: Так как запрос вернет записи из таблицы Categories, выберите выбрать, какие возвращает строки ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image14.png))
...
[![CВыберите имена для методов TableAdapter s](uploading-files-cs/_static/image10.gif)](uploading-files-cs/_static/image15.png)

**Рис. 10**: Выберите имена для адаптера таблицы s методы ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image16.png))
...
[![Aдд элемента управления FileUpload на страницу ASP.NET](uploading-files-cs/_static/image12.gif)](uploading-files-cs/_static/image17.png)

**Рис. 12**: Добавление элемента управления FileUpload страницы ASP.NET ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image18.png))
...
[![Tон пользователя можно выбрать файл для передачи со своего компьютера к серверу](uploading-files-cs/_static/image13.gif)](uploading-files-cs/_static/image19.png)

**Рис. 13**: Пользователь может выбрать файл для передачи со своего компьютера к серверу ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image20.png))
...
[![Tон EvolutionValley.jpg передачи файлов на веб-сервер](uploading-files-cs/_static/image14.gif)](uploading-files-cs/_static/image21.png)

**Рис. 14**: Файл `EvolutionValley.jpg` будут переданы на веб-сервер ([Просмотр полноразмерного изображения](uploading-files-cs/_static/image22.png))
...
> [Далее](displaying-binary-data-in-the-data-web-controls-cs.md)
