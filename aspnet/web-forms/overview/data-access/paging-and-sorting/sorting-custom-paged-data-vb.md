...
title: Сортировка настраиваемых данных на странице (VB) | Документация Майкрософт
...
ms.locfileid: "74618477"
---
# <a name="sorting-custom-paged-data-vb"></a>Упорядочение нестандартно разбитых по страницам данных (VB)

по [Скотт Митчелл](https://twitter.com/ScottOnWriting)

[Скачивание примера приложения](https://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_26_VB.exe) или [Загрузка PDF-файла](sorting-custom-paged-data-vb/_static/datatutorial26vb1.pdf)
...
![Попробуйте использовать другие значения для хранимой процедуры с тремя входными параметрами](sorting-custom-paged-data-vb/_static/image1.png)

**Рис. 1**. Попробуйте использовать другие значения для хранимой процедуры с тремя входными параметрами

[![результаты хранимых процедур отображаются в окно вывода](sorting-custom-paged-data-vb/_static/image3.png)](sorting-custom-paged-data-vb/_static/image2.png)

**Рис. 2**. Результаты хранимых процедур отображаются в окно вывода ([щелкните, чтобы просмотреть изображение с полным размером](sorting-custom-paged-data-vb/_static/image4.png))
...
![Использование хранимой процедуры Жетпродуктспажедандсортед](sorting-custom-paged-data-vb/_static/image6.png)
...
![Выбор имен методов](sorting-custom-paged-data-vb/_static/image8.png)
...
**Рис. 7**. Результаты сортируются по UnitPrice ([щелкните, чтобы просмотреть изображение с полным размером](sorting-custom-paged-data-vb/_static/image11.png))
...
![Попытка отсортировать результаты по поставщику приводит к возникновению следующего исключения среды выполнения](sorting-custom-paged-data-vb/_static/image12.png)
...
![Измените SortExpression SupplierName BoundField s на CompanyName.](sorting-custom-paged-data-vb/_static/image13.png)

**Рис. 9**. изменение SupplierName BoundField s SortExpression на CompanyName

[![теперь результаты можно отсортировать по поставщику](sorting-custom-paged-data-vb/_static/image15.png)](sorting-custom-paged-data-vb/_static/image14.png)

**Рис. 10**. Теперь результаты можно сортировать по поставщикам ([щелкните, чтобы просмотреть изображение с полным размером](sorting-custom-paged-data-vb/_static/image16.png))
