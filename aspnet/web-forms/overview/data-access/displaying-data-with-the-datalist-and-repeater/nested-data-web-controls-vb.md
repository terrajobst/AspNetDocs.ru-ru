...
title: Вложенные веб-элементы управления данными (VB) | Документация Майкрософт
...
ms.locfileid: "78495432"
---
# <a name="nested-data-web-controls-vb"></a>Вложенные веб-элементы управления данными (VB)

по [Скотт Митчелл](https://twitter.com/ScottOnWriting)

[Скачивание примера приложения](https://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_32_VB.exe) или [Загрузка PDF-файла](nested-data-web-controls-vb/_static/datatutorial32vb1.pdf)
...
При внедрении элементов управления в шаблон внешний вид и взаимодействие с пользователем можно настраивать и улучшать. Например, в учебнике [Использование полей TemplateField в руководстве по элементу управления GridView](../custom-formatting/using-templatefields-in-the-gridview-control-vb.md) мы увидели, как настроить отображение GridView s, добавив элемент управления Calendar в TemplateField для отображения даты найма сотрудника. При [добавлении элементов управления проверки в интерфейсы правки и вставки](../editing-inserting-and-deleting-data/adding-validation-controls-to-the-editing-and-inserting-interfaces-vb.md) и настройке учебников по [интерфейсу изменения данных](../editing-inserting-and-deleting-data/customizing-the-data-modification-interface-vb.md) мы увидели, как настраивать интерфейсы редактирования и вставки, добавляя элементы управления проверки, текстовые поля, элементов управления DropDownList и другие веб-элементы управления.
...
[![каждую категорию вместе со своими продуктами, перечислены](nested-data-web-controls-vb/_static/image2.png)](nested-data-web-controls-vb/_static/image1.png)

**Рис. 1**. перечисляются все категории вместе со своими продуктами ([щелкните, чтобы просмотреть изображение с полным размером](nested-data-web-controls-vb/_static/image3.png))
...
[![назовите новый элемент ObjectDataSource CategoriesDataSource](nested-data-web-controls-vb/_static/image5.png)](nested-data-web-controls-vb/_static/image4.png)

**Рис. 2**. Именование нового `CategoriesDataSource` ObjectDataSource ([щелкните, чтобы просмотреть изображение с полным размером](nested-data-web-controls-vb/_static/image6.png))

Настройте ObjectDataSource таким образом, чтобы он запрашивает свои данные из `GetCategories` метода `CategoriesBLL` класса s.

[![настроить ObjectDataSource для использования метода CategoriesBLL класса s](nested-data-web-controls-vb/_static/image8.png)](nested-data-web-controls-vb/_static/image7.png)

**Рис. 3**. Настройка ObjectDataSource для использования метода `GetCategories` `CategoriesBLL` классов ([щелкните, чтобы просмотреть изображение с полным размером](nested-data-web-controls-vb/_static/image9.png))
...
[![перечислены имена и описания категорий s, разделенные горизонтальным правилом.](nested-data-web-controls-vb/_static/image11.png)](nested-data-web-controls-vb/_static/image10.png)

**Рис. 4**. в списке указаны имя и описание каждой категории, разделенные горизонтальным правилом ([щелкните, чтобы просмотреть изображение с полным размером](nested-data-web-controls-vb/_static/image12.png))
...
[![внешний элемент Repeater перечисляет каждую категорию; в внутреннем списке перечислены продукты для этой категории.](nested-data-web-controls-vb/_static/image14.png)](nested-data-web-controls-vb/_static/image13.png)

**Рис. 5**. внешний элемент Repeater перечисляет каждую категорию; в внутреннем списке перечислены продукты для этой категории ([щелкните, чтобы просмотреть изображение с полным размером](nested-data-web-controls-vb/_static/image15.png)).
