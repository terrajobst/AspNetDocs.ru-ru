...
**Рис. 16**: Вторая страница продуктов, которые вывод ([Просмотр полноразмерного изображения](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image46.png))
