...
title: Выполнение пакетных обновленийC#() | Документация Майкрософт
...
ms.locfileid: "78480048"
---
# <a name="performing-batch-updates-c"></a>Выполнение пакетных обновлений (C#)

по [Скотт Митчелл](https://twitter.com/ScottOnWriting)

[Скачивание примера приложения](https://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_37_CS.exe) или [Загрузка PDF-файла](performing-batch-updates-cs/_static/datatutorial37cs1.pdf)
...
[![создать новый элемент управления ObjectDataSource с именем Супплиерсдатасаурце](performing-batch-updates-cs/_static/image5.png)](performing-batch-updates-cs/_static/image4.png)

**Рис. 2**. Создание нового элемента управления ObjectDataSource с именем `SuppliersDataSource` ([щелкните, чтобы просмотреть изображение с полным размером](performing-batch-updates-cs/_static/image6.png))
...
[![получить сведения о поставщике с помощью метода-поставщика ()](performing-batch-updates-cs/_static/image8.png)](performing-batch-updates-cs/_static/image7.png)

**Рис. 3**. Получение сведений о поставщике с помощью метода `GetSuppliers()` ([щелкните, чтобы просмотреть изображение с полным размером](performing-batch-updates-cs/_static/image9.png))

[![установите для раскрывающегося списка значение (нет) на вкладке обновление.](performing-batch-updates-cs/_static/image11.png)](performing-batch-updates-cs/_static/image10.png)

**Рис. 4**. Установка в раскрывающемся списке значения (нет) на вкладке "обновление" ([щелкните, чтобы просмотреть изображение с полным размером](performing-batch-updates-cs/_static/image12.png))
...
[![каждый поставщик в DataList доступен для редактирования](performing-batch-updates-cs/_static/image14.png)](performing-batch-updates-cs/_static/image13.png)

**Рис. 5**. Каждый поставщик в DataList доступен для редактирования ([щелкните, чтобы просмотреть изображение с полным размером](performing-batch-updates-cs/_static/image15.png))
...
[![две кнопки "обновить все" добавлены на страницу](performing-batch-updates-cs/_static/image17.png)](performing-batch-updates-cs/_static/image16.png)

**Рис. 6**. на страницу были добавлены две кнопки "обновить все" ([щелкните, чтобы просмотреть изображение с полным размером](performing-batch-updates-cs/_static/image18.png))
...
> [Назад](an-overview-of-editing-and-deleting-data-in-the-datalist-cs.md)
> [Вперед](handling-bll-and-dal-level-exceptions-cs.md)
