...
[![EACH строки в GridView-Editable](batch-updating-cs/_static/image1.gif)](batch-updating-cs/_static/image1.png)
...
[![CНастройка ObjectDataSource на использование класса ProductsBLL](batch-updating-cs/_static/image2.gif)](batch-updating-cs/_static/image3.png)
...
[![Rзагружать данные продуктов, с помощью метода GetProducts](batch-updating-cs/_static/image3.gif)](batch-updating-cs/_static/image5.png)
...
[![SET раскрывающиеся списки в UPDATE, INSERT и DELETE вкладок (нет)](batch-updating-cs/_static/image4.gif)](batch-updating-cs/_static/image7.png)
...
[![TТеперь он ProductName TemplateField содержит текстовое поле и RequiredFieldValidator](batch-updating-cs/_static/image6.gif)](batch-updating-cs/_static/image9.png)
...
[![Aдд CompareValidator, чтобы удостовериться в цену, ввода является значение валюты не отрицательны](batch-updating-cs/_static/image7.gif)](batch-updating-cs/_static/image11.png)
...
[![CНастройка ObjectDataSource на использование класса CategoriesBLL](batch-updating-cs/_static/image8.gif)](batch-updating-cs/_static/image13.png)

**Рис. 8**: Настройка ObjectDataSource для использования `CategoriesBLL` класс ([Просмотр полноразмерного изображения](batch-updating-cs/_static/image14.png))


[![Rзагружать данные категории, с помощью метода GetCategories](batch-updating-cs/_static/image9.gif)](batch-updating-cs/_static/image15.png)
...
[![SET раскрывающиеся списки в UPDATE и DELETE вкладок (нет)](batch-updating-cs/_static/image10.gif)](batch-updating-cs/_static/image17.png)
...
[![BIND DropDownList к CategoriesDataSource](batch-updating-cs/_static/image11.gif)](batch-updating-cs/_static/image19.png)
...
[![EACH строке GridView-Editable](batch-updating-cs/_static/image13.gif)](batch-updating-cs/_static/image21.png)
...
[![Tон теперь включает два обновления продуктов кнопок страниц](batch-updating-cs/_static/image16.gif)](batch-updating-cs/_static/image23.png)
