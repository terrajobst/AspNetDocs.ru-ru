...
[![Oчтение одной можно установить флажок одновременно](creating-mutually-exclusive-checkboxes-cs/_static/image2.png)](creating-mutually-exclusive-checkboxes-cs/_static/image1.png)
...
> [Далее](creating-mutually-exclusive-checkboxes-vb.md)
