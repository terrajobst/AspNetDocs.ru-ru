...
[![Tон модальное всплывающее окно отображается в назначенной позиции](positioning-a-modalpopup-vb/_static/image2.png)](positioning-a-modalpopup-vb/_static/image1.png)
