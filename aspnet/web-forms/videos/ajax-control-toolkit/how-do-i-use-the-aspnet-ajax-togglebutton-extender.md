...
---
# <a name="how-do-i-use-the-aspnet-ajax-togglebutton-extender"></a>[Инструкции] Как использовать расширитель ASP.NET AJAX ToggleButton?

по [(Joe Stagner)](https://github.com/JoeStagner)

Демонстрируется использование расширяющий элемент управления ToggleButton для изменения поведения и внешнего вида стандартный элемент управления ASP.NET CheckBox для улучшения пользовательского интерфейса.

[&#9654;Просмотрите видео (7 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-use-the-aspnet-ajax-togglebutton-extender)
