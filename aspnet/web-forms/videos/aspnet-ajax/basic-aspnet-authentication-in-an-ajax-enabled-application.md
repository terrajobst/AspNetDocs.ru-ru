...
В этом видеоролике я продемонстрирую проверку подлинности в веб-приложении AJAX, используя обычную проверку подлинности на основе форм ASP.NET.

[&#9654;Смотреть видео (31 минута)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/basic-aspnet-authentication-in-an-ajax-enabled-application)
