...
---
# <a name="aspnet-45-web-forms-model-binding"></a>Привязка модели веб-форм ASP.NET 4.5

по [(Scott hanselman)](https://github.com/shanselman)

[&#9654;Просмотрите видео (7 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-45-web-forms-model-binding)

> [!div class="step-by-step"]
> [Назад](aspnet-vnext-videos-model-binding-part-3-updating.md)
> [Вперед](aspnet-45-web-forms-strong-typed-data-controls.md)
