...
> Новые возможности ASP.NET и функциональные возможности, доступные в .NET Framework 4.

- [Ajax](ajax/index.md)

    - [Принудительный синтаксис JavaScript для клиентских элементов управления Майкрософт](ajax/aspnet-4-quick-hit-imperative-javascript-syntax-for-microsoft-client-side-controls.md)
...
- [Ядро](core/index.md)
    ...
    - [Очистка файлов Web.Config](core/aspnet-4-quick-hit-clean-webconfig-files.md)
    - [Прогнозируемые идентификаторы клиентов](core/aspnet-4-quick-hit-predictable-client-ids.md)
    - [Метод программы HtmlEncoder](core/aspnet-4-quick-hit-the-htmlencoder-utility-method.md)
- [Данные](data/index.md)

    - [Выбор сохраняемых строк GridView](data/aspnet-4-quick-hit-persistent-gridview-row-selection.md)
...
- [Routing](routing/index.md)
    ...
    - [Декларативная маршрутизация WebForms](routing/aspnet-4-quick-hit-declarative-webforms-routing.md)
    - [Исходящая маршрутизация WebForms](routing/aspnet-4-quick-hit-outbound-webforms-routing.md)
    - [Использование маршрутизации с помощью веб-форм ASP.NET](routing/how-do-i-use-routing-with-aspnet-web-forms.md)
    - [Работа с URL-адресами в маршрутизации ASP.NET](routing/how-do-i-work-with-urls-in-aspnet-routing.md)
- [Оптимизация поисковых систем](seo/index.md)

    - [Динамические метаданные](seo/aspnet-4-quick-hit-dynamic-metadata.md)
