...
---
# <a name="aspnet-4-quick-hit---predictable-client-ids"></a>ASP.NET 4 "быстрый попадание" — предсказуемые идентификаторы клиентов

кем [Джо Stagner)](https://github.com/JoeStagner)

В этом видеоролике вы узнаете о свойстве ClientIDMode, которое позволяет точно указать, как идентификатор клиента создается для элементов управления. 

[&#9654;Смотреть видео (10 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-predictable-client-ids)
