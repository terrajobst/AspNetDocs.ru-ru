...
Связь обнаружения зависит от используемой версии .NET и веб-платформы. Следующий код можно вызвать на сайте вызова [HttpCookie](/dotnet/api/system.web.httpcookie) :
...
Начиная с версии ранний `80.0.3975.0`, нестрогая и ОБРАТная разрешающая опасность можно отключить для целей тестирования, используя новый флаг `--enable-features=SameSiteDefaultChecksMethodRigorously`, чтобы разрешить тестирование сайтов и служб в конечном итоге, когда устранение рисков было удалено. Дополнительные сведения см. в статье Chromium Projects [SameSite Updates](https://www.chromium.org/updates/same-site) .
...
* [Советы по тестированию и отладке SameSite по умолчанию и "SameSite = None; Защита файлов cookie](https://www.chromium.org/updates/same-site/test-debug)
