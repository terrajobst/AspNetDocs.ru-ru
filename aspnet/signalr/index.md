...
- [Руководство](overview/index.md)
    ...
    - [Тестирование и отладка](overview/testing-and-debugging/index.md)
        ...
        - [Устранение неполадок SignalR](overview/testing-and-debugging/troubleshooting.md)
        - [Модульное тестирование приложений SignalR](overview/testing-and-debugging/unit-testing-signalr-applications.md)
        - [Включение трассировки SignalR](overview/testing-and-debugging/enabling-signalr-tracing.md)
    - [Безопасность](overview/security/index.md)

        - [Общие сведения о безопасности SignalR](overview/security/introduction-to-security.md)
        - [Проверка подлинности и авторизация для концентраторов SignalR](overview/security/hub-authorization.md)
        - [Проверка подлинности и авторизация для постоянных подключений SignalR](overview/security/persistent-connection-authorization.md)
    - [Производительность](overview/performance/index.md)

        - [Производительность SignalR](overview/performance/signalr-performance.md)
        - [Общие сведения о масштабировании в SignalR](overview/performance/scaleout-in-signalr.md)
        - [Масштабирование SignalR с помощью служебной шины Azure](overview/performance/scaleout-with-windows-azure-service-bus.md)
        - [Масштабирование SignalR с помощью Redis](overview/performance/scaleout-with-redis.md)
        - [Масштабирование SignalR с помощью SQL Server](overview/performance/scaleout-with-sql-server.md)
        - [Тестирование плотности подключений SignalR с помощью Crank](overview/performance/signalr-connection-density-testing-with-crank.md)
        - [Использование счетчиков производительности SignalR в веб-роли Azure](overview/performance/using-signalr-performance-counters-in-an-azure-web-role.md)
    - [Развертывание и размещение](overview/deployment/index.md)

        - [Учебник. Резидентное размещение SignalR](overview/deployment/tutorial-signalr-self-host.md)
        - [Использование SignalR с веб-приложениями в службе приложений Azure](overview/deployment/using-signalr-with-azure-web-sites.md)
...
- [Видеоролики](videos/index.md)
    ...
    - [Видеоролики по ASP.NET SignalR](videos/getting-started/index.md)
        ...
        - [SignalR и веб-сокеты](videos/getting-started/signalr-and-web-sockets.md)
