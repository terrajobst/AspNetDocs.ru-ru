...
Пусто. Содержит минимальный набор файлов для проекта MVC ASP.NET, включая структуру каталогов по умолчанию для проектов ASP.NET MVC, файл Site. CSS, содержащий стили по умолчанию ASP.NET MVC и каталог Scripts, который содержит файлы JavaScript по умолчанию.
...
Пусто. Содержит минимальный набор файлов для проекта MVC ASP.NET, включая структуру каталогов по умолчанию для проектов ASP.NET MVC, небольшой файл Site. CSS, содержащий стили по умолчанию ASP.NET MVC и каталог Scripts, который содержит файлы JavaScript по умолчанию.
...
© Корпорация Майкрософт (Microsoft Corporation), 2011 Все права защищены. Данный документ представлен "как есть". Сведения и идеи, изложенные в этом документе, включая URL-адреса и прочие ссылки на веб-сайты в Интернете, могут быть изменены без предварительного уведомления. Вы принимаете на себя ответственность за риски, связанные с использованием этого документа.
