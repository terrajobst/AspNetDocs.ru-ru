...
---
# <a name="displaying-data-in-a-chart-part-1"></a>Отображение данных на диаграмме (часть 1)

кем [Джо Stagner)](https://github.com/JoeStagner)

Видео аккомпанимент. Руководство по отображению данных в диаграмме (часть 1)

[&#9654;Смотреть видео (12 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/displaying-data-in-a-chart-(part-1))
