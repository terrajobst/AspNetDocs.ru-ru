...
Часть 1 вы познакомитесь с WebMatrix и как можно установить и использовать его.

[&#9654;Просмотрите видео (2 минуты)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/install-and-use-the-microsoft-webmatrix-tool)
