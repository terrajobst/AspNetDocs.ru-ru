...
> 
> > [!NOTE]
> > Если вы хотите отправлять изображения и управление ими (например, перевернуть или изменить их размер), см. в разделе [работа с изображениями на сайте веб-страниц ASP.NET](/aspnet/web-pages/overview/ui-layouts-and-themes/9-working-with-images).
> 
> 
> **Вы узнаете, как:** 
> 
