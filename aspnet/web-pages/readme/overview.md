...
> <span data-ttu-id="d3a9b-129">См. в разделе [пошаговые инструкции для публикации приложений](https://go.microsoft.com/fwlink/?LinkID=196149)</span><span class="sxs-lookup"><span data-stu-id="d3a9b-129">See [Step-by-Step Instructions for Publishing Applications](https://go.microsoft.com/fwlink/?LinkID=196149)</span></span>
...
[<span data-ttu-id="d3a9b-337">https://go.microsoft.com/fwlink/?LinkID=207675&amp;clcid=0x409</span><span class="sxs-lookup"><span data-stu-id="d3a9b-337">https://go.microsoft.com/fwlink/?LinkID=207675&amp;clcid=0x409</span></span>](https://go.microsoft.com/fwlink/?LinkID=207675&amp;clcid=0x409)
...
> <span data-ttu-id="d3a9b-373">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-373">**Workaround**</span></span>  
...
> <span data-ttu-id="d3a9b-385">В **параметров публикации** диалоговое окно, если URL-адрес назначения не начинается с `http://` или `https://`, сайт может не работать после развертывания.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-385">In the **Publishing Settings** dialog box, if the destination URL does not begin with `http://` or `https://`, the site might not work after deployment.</span></span>
> 
> <span data-ttu-id="d3a9b-386">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-386">**Workaround**</span></span>  
> <span data-ttu-id="d3a9b-387">Убедитесь, что прежде чем опубликовать сайт, URL-адрес назначения в **параметры публикации** диалоговое окно начинается с `http://` или `https://`.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-387">Make sure that before you publish a site, the destination URL in the **Publish Settings** dialog box starts with `http://` or `https://`.</span></span>


#### <a name="issue-publishing-a-mysql-database-fails-with-the-error-failed-to-publish-the-database-this-can-happen-if-the-remote-database-cannot-run-the-script"></a><span data-ttu-id="d3a9b-388">Проблема. Публикация базы данных MySQL завершается с ошибкой «не удалось опубликовать базу данных.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-388">Issue: Publishing a MySQL database fails with the error "Failed to publish the database.</span></span> <span data-ttu-id="d3a9b-389">Это может произойти, если удаленная база данных нельзя запустить сценарий.»</span><span class="sxs-lookup"><span data-stu-id="d3a9b-389">This can happen if the remote database cannot run the script."</span></span>

> <span data-ttu-id="d3a9b-390">Эта ошибка может возникнуть по ряду причин.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-390">The error can occur for a number of reasons.</span></span> <span data-ttu-id="d3a9b-391">Одна из причин, можно увидеть, эта ошибка — Если скрипт базы данных одинарная кавычка (') и не может базы данных MySQL назначения по умолчанию используется кодировка UTF-8.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-391">One reason you can see this error is if the database script contains a single quotation character (') and the destination MySQL database's default character set is not to UTF-8.</span></span>
> 
> <span data-ttu-id="d3a9b-392">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-392">**Workaround**</span></span>  
> <span data-ttu-id="d3a9b-393">Задайте кодировку по умолчанию для удаленной базы данных MySQL в UTF-8.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-393">Set the default character set for the remote MySQL database to UTF-8.</span></span>


#### <a name="issue-some-links-are-not-visible-in-dotnetnuke-after-publishing-or-downloading-the-site"></a><span data-ttu-id="d3a9b-394">Проблема. Некоторые ссылки не отображаются в DotNetNuke после публикации или загрузке сайта</span><span class="sxs-lookup"><span data-stu-id="d3a9b-394">Issue: Some links are not visible in DotNetNuke after publishing or downloading the site</span></span>

> <span data-ttu-id="d3a9b-395">Если опубликовать или загрузить узла DotNetNuke, может потребоваться очистить кэш, чтобы получить новые ссылки появятся на сайте.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-395">If you publish or download a DotNetNuke site, you might need to clear the cache to get the new links to appear on the site.</span></span>
> 
> <span data-ttu-id="d3a9b-396">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-396">**Workaround**</span></span>
> 
> 1. <span data-ttu-id="d3a9b-397">Войдите в систему как «Узел».</span><span class="sxs-lookup"><span data-stu-id="d3a9b-397">Log in as "Host".</span></span>
> 2. <span data-ttu-id="d3a9b-398">Перейдите в меню "узел" и выберите **параметры узла**.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-398">Go to the host menu and select **Host Settings**.</span></span>
> 3. <span data-ttu-id="d3a9b-399">Прокрутите список вниз и в разделе **Дополнительные параметры**, разверните **параметры производительности**.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-399">Scroll down and under **Advanced Settings**, expand **Performance Settings**.</span></span>
> 4. <span data-ttu-id="d3a9b-400">Нажмите кнопку **очистить кэш** ссылку для страниц.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-400">Click the **Clear Cache** link for pages.</span></span>
> 5. <span data-ttu-id="d3a9b-401">Перейдите к нижней части страницы и перезапустить приложение.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-401">Go to the bottom of the page and restart the application.</span></span>


#### <a name="issue-some-links-in-atomsite-are-broken-after-you-download-a-published-site"></a><span data-ttu-id="d3a9b-402">Проблема. Некоторые ссылки в AtomSite не работают после загрузки опубликованного узла</span><span class="sxs-lookup"><span data-stu-id="d3a9b-402">Issue: Some links in AtomSite are broken after you download a published site</span></span>

> <span data-ttu-id="d3a9b-403">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-403">**Workaround**</span></span>  
> <span data-ttu-id="d3a9b-404">В *service.config* файл, *users.config* файла и всех *.xml* файлов, замените строку URL-адрес (например, `http://myhost.com/atomsite`) с локальной (например, `http://localhost:1239`).</span><span class="sxs-lookup"><span data-stu-id="d3a9b-404">In the *service.config* file, *users.config* file, and all *.xml* files, replace the URL string (for example, `http://myhost.com/atomsite`) with the local one (for example, `http://localhost:1239`).</span></span>


#### <a name="issue-mysql-based-applications-like-wordpress-fail-to-publish-and-report-a-database-error"></a><span data-ttu-id="d3a9b-405">Проблема. Приложения на основе MySQL, такие как WordPress не удалось опубликовать и сообщения об ошибке в базе данных</span><span class="sxs-lookup"><span data-stu-id="d3a9b-405">Issue: MySQL-based applications like WordPress fail to publish and report a database error</span></span>

> <span data-ttu-id="d3a9b-406">По умолчанию WebMatrix устанавливается MySQL с кодировкой UTF-8.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-406">By default, WebMatrix installs MySQL with the UTF-8 character set.</span></span> <span data-ttu-id="d3a9b-407">Если установить MySQL самостоятельно, а не кодировку UTF-8 (например, это Latin1), процесс публикации для баз данных может завершиться сбоем.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-407">If you install MySQL on your own, and the character set is not UTF-8 (for example, it is Latin1), the publish process for databases might fail.</span></span>
> 
> <span data-ttu-id="d3a9b-408">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-408">**Workaround**</span></span>
> 
> 1. <span data-ttu-id="d3a9b-409">Измените кодировку для MySQL в UTF-8.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-409">Change the character set for MySQL to UTF-8.</span></span> <span data-ttu-id="d3a9b-410">(Дополнительные сведения см. в разделе [набор символов сервера и параметры сортировки](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html) веб-сайта MySQL.)</span><span class="sxs-lookup"><span data-stu-id="d3a9b-410">(For details, see [Server Character Set and Collation](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html) on the MySQL website.)</span></span>
> 2. <span data-ttu-id="d3a9b-411">Переустановите приложение.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-411">Reinstall the application.</span></span>
> 3. <span data-ttu-id="d3a9b-412">Повторно опубликуйте приложение.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-412">Republish the application.</span></span>


#### <a name="issue-download-published-site-fails-for-applications-that-have-browser-based-setup"></a><span data-ttu-id="d3a9b-413">Проблема. «Скачать опубликованного узла» завершается ошибкой для приложений, имеющих установки на основе браузера</span><span class="sxs-lookup"><span data-stu-id="d3a9b-413">Issue: "Download published site" fails for applications that have browser-based setup</span></span>

> <span data-ttu-id="d3a9b-414">Некоторые приложения (например, Kentico CMS) требуется запускать их в браузере для выполнения программы установки после установки, таких как создание базы данных.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-414">Some applications (for example, Kentico CMS) require you to launch them in the browser in order to perform post-installation setup such as creating a database.</span></span> <span data-ttu-id="d3a9b-415">Если вы публикуете приложение, подобное этому без завершения установки на основе веб-обозревателя, попытки загрузить на том же сайте с удаленного сервера завершится ошибкой.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-415">If you publish an application like this without completing the browser-based setup, attempting to download the same site from a remote server will fail.</span></span>
> 
> <span data-ttu-id="d3a9b-416">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-416">**Workaround**</span></span>  
> <span data-ttu-id="d3a9b-417">Готово для установки на основе браузера перед публикацией на сайте.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-417">Finish browser-based setup before publishing the site.</span></span>


#### <a name="issue-download-published-site-fails-with-a-database-error-for-dotnetnuke-and-kooboo-cms"></a><span data-ttu-id="d3a9b-418">Проблема. «Скачать опубликованного узла» приведет к ошибке базы данных для DotNetNuke и Kooboo CMS</span><span class="sxs-lookup"><span data-stu-id="d3a9b-418">Issue: "Download published site" fails with a database error for DotNetNuke and Kooboo CMS</span></span>

> <span data-ttu-id="d3a9b-419">Если при попытке загрузить приложения с сервера, и у вас есть учетные данные администратора в строке подключения базы данных в **параметры публикации** диалоговое окно, может появиться следующая ошибка в журнале публикации:</span><span class="sxs-lookup"><span data-stu-id="d3a9b-419">If you try to download an application from a server and you have administrator credentials in the database connection string in the **Publish Settings** dialog, you might see the following error in the publish log:</span></span>
> 
> [!code-console[Main](overview/samples/sample9.cmd)]
> 
> <span data-ttu-id="d3a9b-420">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="d3a9b-420">**Workaround**</span></span>  
> <span data-ttu-id="d3a9b-421">Если это целесообразно, повторно опубликовать сайт (или опубликовать его) с помощью учетных данных без прав администратора для базы данных.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-421">If practical, republish the site (or have it published) using non-administrator credentials for the database.</span></span>


<a id="More_Info"></a>

## <a name="for-more-information"></a><span data-ttu-id="d3a9b-422">Дополнительные сведения</span><span class="sxs-lookup"><span data-stu-id="d3a9b-422">For More Information</span></span>

<span data-ttu-id="d3a9b-423">Дополнительные сведения о WebMatrix 1.0 см. на следующих веб-сайтах:</span><span class="sxs-lookup"><span data-stu-id="d3a9b-423">For more information about WebMatrix 1.0, see the following websites:</span></span>

- [<span data-ttu-id="d3a9b-424">IIS.net</span><span class="sxs-lookup"><span data-stu-id="d3a9b-424">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="d3a9b-425">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d3a9b-425">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="d3a9b-426">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="d3a9b-426">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

<span data-ttu-id="d3a9b-427">© 2011 Корпорация Майкрософт.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-427">© 2011 Microsoft Corporation.</span></span> <span data-ttu-id="d3a9b-428">Все права защищены.</span><span class="sxs-lookup"><span data-stu-id="d3a9b-428">All Rights Reserved.</span></span> <span data-ttu-id="d3a9b-429">[Условия использования](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="d3a9b-429">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
