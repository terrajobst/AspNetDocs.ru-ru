...
> <span data-ttu-id="5a5a4-127">См. в разделе [пошаговые инструкции для публикации приложений](https://go.microsoft.com/fwlink/?LinkID=196149)</span><span class="sxs-lookup"><span data-stu-id="5a5a4-127">See [Step-by-Step Instructions for Publishing Applications](https://go.microsoft.com/fwlink/?LinkID=196149)</span></span>
...
#### <a name="issue-cannot-uninstall-sql-server-compact-using-the-command-line"></a><span data-ttu-id="5a5a4-155">Проблема. Не удается удалить SQL Server Compact с помощью командной строки</span><span class="sxs-lookup"><span data-stu-id="5a5a4-155">Issue: Cannot uninstall SQL Server Compact using the command line</span></span>
...
> <span data-ttu-id="5a5a4-194">Следующие типы были перемещены `WebMatrix.WebData` сборки:</span><span class="sxs-lookup"><span data-stu-id="5a5a4-194">The following types were moved to the `WebMatrix.WebData` assembly:</span></span>
> 
...
> 
> <span data-ttu-id="5a5a4-238">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="5a5a4-238">**Workaround**</span></span>  
...
#### <a name="issue-uninstalling-the-net-framework-version-4-disables-aspnet-web-pages-with-razor-syntax"></a><span data-ttu-id="5a5a4-260">Проблема. Удаление .NET Framework версии 4 отключает веб-страниц ASP.NET с синтаксисом Razor</span><span class="sxs-lookup"><span data-stu-id="5a5a4-260">Issue: Uninstalling the .NET Framework version 4 disables ASP.NET Web Pages with Razor Syntax</span></span>
...
> <span data-ttu-id="5a5a4-281">При использовании веб-страниц ASP.NET в проекте веб-приложения или приложения ASP.NET MVC, может появиться ошибка, *WebPageHttpApplication* не удается найти.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-281">If you were using ASP.NET Web Pages in a Web Application project or ASP.NET MVC application, you might see an error that *WebPageHttpApplication* cannot be found.</span></span>
> 
...
>     - <span data-ttu-id="5a5a4-294">Копировать *C:\Program Files\Microsoft SQL Server Compact Edition\v4.0\Private\amd64\\*\* **для** *\Bin\amd64*</span><span class="sxs-lookup"><span data-stu-id="5a5a4-294">Copy *C:\Program Files\Microsoft SQL Server Compact Edition\v4.0\Private\amd64\\*\* **to** *\Bin\amd64*</span></span>
...
#### <a name="issue-publishing-a-mysql-database-fails-with-the-error-failed-to-publish-the-database-this-can-happen-if-the-remote-database-cannot-run-the-script"></a><span data-ttu-id="5a5a4-341">Проблема. Публикация базы данных MySQL завершается с ошибкой «не удалось опубликовать базу данных.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-341">Issue: Publishing a MySQL database fails with the error "Failed to publish the database.</span></span> <span data-ttu-id="5a5a4-342">Это может произойти, если удаленная база данных нельзя запустить сценарий.»</span><span class="sxs-lookup"><span data-stu-id="5a5a4-342">This can happen if the remote database cannot run the script."</span></span>
...
#### <a name="issue-wcf-applications-fail-to-run-with-iis-express"></a><span data-ttu-id="5a5a4-353">Проблема. WCF приложения перестают работать с IIS Express</span><span class="sxs-lookup"><span data-stu-id="5a5a4-353">Issue: WCF applications fail to run with IIS Express</span></span>
...
> - <span data-ttu-id="5a5a4-372">В Windows XP добавьте пользователя в группу безопасности администраторов.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-372">On Windows XP, add the user to the Administrators security group.</span></span>

#### <a name="issue-site-from-web-gallery-is-disabled"></a><span data-ttu-id="5a5a4-373">Проблема. Отключена «Site from Web Gallery.»</span><span class="sxs-lookup"><span data-stu-id="5a5a4-373">Issue: "Site from Web Gallery" is disabled</span></span>

> <span data-ttu-id="5a5a4-374">**Site from Web Gallery** параметр отключен, если не установлен установщик веб-платформы 3.0.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-374">The **Site from Web Gallery** option is disabled if the Web Platform Installer 3.0 is not installed.</span></span>
> 
> <span data-ttu-id="5a5a4-375">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="5a5a4-375">**Workaround**</span></span>  
> <span data-ttu-id="5a5a4-376">Установка [Microsoft Web Platform Installer 3.0](https://go.microsoft.com/fwlink/?LinkID=194638).</span><span class="sxs-lookup"><span data-stu-id="5a5a4-376">Install the [Microsoft Web Platform Installer 3.0](https://go.microsoft.com/fwlink/?LinkID=194638).</span></span>

#### <a name="issue-on-windows-server-2003-iis-express-does-not-start-for-a-non-administrative-user"></a><span data-ttu-id="5a5a4-377">Проблема. В Windows Server 2003 IIS Express не запускается для обычных пользователей</span><span class="sxs-lookup"><span data-stu-id="5a5a4-377">Issue: On Windows Server 2003, IIS Express does not start for a non-administrative user</span></span>

> <span data-ttu-id="5a5a4-378">В Windows Server 2003 при открывает страницу или запуске IIS Express и IIS Express не запускается.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-378">On Windows Server 2003, when you launch a page or start IIS Express, IIS Express does not start.</span></span> <span data-ttu-id="5a5a4-379">Для веб-страниц выводится сообщение об ошибке, указывающее, что приложения был запущен пользователем без прав администратора.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-379">For Web pages, an error is displayed that indicates that the application has been started by a non-administrative user.</span></span>
> 
> <span data-ttu-id="5a5a4-380">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="5a5a4-380">**Workaround**</span></span>  
> <span data-ttu-id="5a5a4-381">Запуск WebMatrix бета-версии 3, пользователь с правами администратора.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-381">Start WebMatrix Beta 3 as an administrative user.</span></span> <span data-ttu-id="5a5a4-382">Дополнительные сведения см. в следующей статье базы знаний:</span><span class="sxs-lookup"><span data-stu-id="5a5a4-382">For more details, see the following KnowledgeBase article:</span></span>  
>   
> [<span data-ttu-id="5a5a4-383">Приложение, которое запускается с пользователь без прав администратора не может прослушивать HTTP-трафика компьютера, на котором приложение выполняется в Windows Vista, Windows Server 2003 или Windows XP.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-383">An application that is started by a non-administrative user cannot listen to the HTTP traffic of the computer on which the application is running in Windows Vista, Windows Server 2003, or Windows XP.</span></span>](https://support.microsoft.com/kb/939786)

#### <a name="issue-google-chrome-is-not-available-as-a-run-option"></a><span data-ttu-id="5a5a4-384">Проблема. Google Chrome не поддерживается в случае выполнения</span><span class="sxs-lookup"><span data-stu-id="5a5a4-384">Issue: Google Chrome is not available as a Run option</span></span>

> <span data-ttu-id="5a5a4-385">Google Chrome не отображается в списке браузеров в разделе **запуска** на **Главная** вкладки.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-385">Google Chrome is not displayed in the list of browsers under **Run** on the **Home** tab.</span></span>
> 
> <span data-ttu-id="5a5a4-386">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="5a5a4-386">**Workaround**</span></span>  
> <span data-ttu-id="5a5a4-387">В некоторых версиях Google Chrome не регистрируют себя правильно с функцией программы по умолчанию в Windows.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-387">Some versions of Google Chrome do not register themselves correctly with the Default Programs feature in Windows.</span></span> <span data-ttu-id="5a5a4-388">Обойти это ограничение, Google Chrome, выберите пункт *Настройка и управление Google Chrome* меню, щелкните *параметры*, а затем нажмите кнопку *марки Google Chrome обозревателем по умолчанию*.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-388">As a workaround, start Google Chrome, click the *Customize and control Google Chrome* menu, click *Options*, and then click *Make Google Chrome my default browser*.</span></span>

#### <a name="issue-the-foreign-key-dialog-box-doesnt-allow-entering-a-primary-key"></a><span data-ttu-id="5a5a4-389">Проблема. Диалоговое окно «Foreign Key» не позволяет ввести первичный ключ</span><span class="sxs-lookup"><span data-stu-id="5a5a4-389">Issue: The "Foreign Key" dialog box doesn't allow entering a primary key</span></span>

> <span data-ttu-id="5a5a4-390">**Foreign Key** диалоговое окно не позволяет ввести имя первичного ключа из таблицы первичного ключа.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-390">The **Foreign Key** dialog box does not allow you to enter the primary key name from the primary key table.</span></span>
> 
> <span data-ttu-id="5a5a4-391">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="5a5a4-391">**Workaround**</span></span>  
> <span data-ttu-id="5a5a4-392">Это сделано намеренно.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-392">This is intentional.</span></span> <span data-ttu-id="5a5a4-393">Необходимо ввести имя первичного ключа из таблицы первичного ключа.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-393">You do not need to enter the name of the primary key from the primary key table.</span></span>

#### <a name="issue-the-relationships-button-is-disabled"></a><span data-ttu-id="5a5a4-394">Проблема. Кнопка «Связи» отключена</span><span class="sxs-lookup"><span data-stu-id="5a5a4-394">Issue: The "Relationships" button is disabled</span></span>

> <span data-ttu-id="5a5a4-395">**Связи** под кнопкой **таблицы** вкладке **баз данных** рабочей области отключен для базы данных SQL Server Compact.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-395">The **Relationships** button under the **Table** tab in the **Databases** workspace is disabled for SQL Server Compact databases.</span></span>
> 
> <span data-ttu-id="5a5a4-396">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="5a5a4-396">**Workaround**</span></span>  
> <span data-ttu-id="5a5a4-397">Отсутствует.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-397">None.</span></span> <span data-ttu-id="5a5a4-398">SQL Server Compact не поддерживает связи между таблицами.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-398">SQL Server Compact does not support relationships between tables.</span></span>

#### <a name="issue-parameterized-sql-queries-throw-exceptions"></a><span data-ttu-id="5a5a4-399">Проблема. Параметризованные SQL-запросы исключения.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-399">Issue: Parameterized SQL queries throw exceptions</span></span>

> <span data-ttu-id="5a5a4-400">В SQL Server Compact 4.0, если вы не укажете тип данных таких как `SqlDbType` или `DbType` для параметров в параметризованных запросах, создается исключение при выполнении запроса.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-400">In SQL Server Compact 4.0, if you do not specify a data type such as `SqlDbType` or `DbType` for parameters in parameterized queries, an exception is thrown when the query runs.</span></span>
> 
> <span data-ttu-id="5a5a4-401">**Инструкции по решению**</span><span class="sxs-lookup"><span data-stu-id="5a5a4-401">**Workaround**</span></span>  
> <span data-ttu-id="5a5a4-402">Явно задать тип данных для параметров, таких как `SqlDbType` или `DbType`.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-402">Explicitly set the data type for parameters such as `SqlDbType` or `DbType`.</span></span> <span data-ttu-id="5a5a4-403">Это крайне важно в случае с типами данных больших двоичных ОБЪЕКТОВ (`image` и `ntext`).</span><span class="sxs-lookup"><span data-stu-id="5a5a4-403">This is critical in the case of BLOB data types (`image` and `ntext`).</span></span> <span data-ttu-id="5a5a4-404">Используйте код, аналогичный следующему:</span><span class="sxs-lookup"><span data-stu-id="5a5a4-404">Use code like the following:</span></span>
> 
...
## <a name="for-more-information"></a><span data-ttu-id="5a5a4-405">Дополнительные сведения</span><span class="sxs-lookup"><span data-stu-id="5a5a4-405">For More Information</span></span>

<span data-ttu-id="5a5a4-406">Дополнительные сведения о WebMatrix бета-версии 3 см. в разделе следующих веб-сайтах:</span><span class="sxs-lookup"><span data-stu-id="5a5a4-406">For more information about WebMatrix Beta 3, see the following websites:</span></span>

- [<span data-ttu-id="5a5a4-407">IIS.net</span><span class="sxs-lookup"><span data-stu-id="5a5a4-407">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="5a5a4-408">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="5a5a4-408">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="5a5a4-409">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="5a5a4-409">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

---

<span data-ttu-id="5a5a4-410">© 2010 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-410">© 2010 Microsoft Corporation.</span></span> <span data-ttu-id="5a5a4-411">Все права защищены.</span><span class="sxs-lookup"><span data-stu-id="5a5a4-411">All Rights Reserved.</span></span> <span data-ttu-id="5a5a4-412">[Условия использования](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="5a5a4-412">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
