...
Давайте добавим два операторы using в верхней части файла. Пространство имен платформы Entity Framework, ссылающийся на первый и второй ссылается на пространство имен где наши `MovieInitializer` класса жизни:

[!code-csharp[Main](adding-a-new-field/samples/sample6.cs)]

Затем найдите `Application_Start` метод и добавьте вызов `Database.SetInitializer` в начале метода, как показано ниже:
