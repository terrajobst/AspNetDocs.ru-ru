...
Нажмите CTRL+F5, чтобы запустить приложение. Выберите ссылку изменить, чтобы убедиться, что поле ввода для даты выпуска показывает только дату.
...
Нажмите CTRL+F5, чтобы запустить приложение. Можно проверить, что свойство `ReleaseDate` в представлении редактирования использует шаблон редактирования, поскольку шаблон отображает &quot;шаблон даты&quot; непосредственно перед полем ввода текста `ReleaseDate`, как показано на рисунке ниже.
...
Нажмите CTRL+F5, чтобы запустить приложение. Выберите ссылку изменить, а затем поместите точку вставки в поле **ReleaseDate** . Откроется всплывающий календарь jQuery UI.
