...
- [Начало работы с ASP.NET MVC 4](getting-started-with-aspnet-mvc4/index.md)
    ...
    - [Доступ к данным модели из контроллера](getting-started-with-aspnet-mvc4/accessing-your-models-data-from-a-controller.md)
    - [Изучение методов Edit и представления Edit](getting-started-with-aspnet-mvc4/examining-the-edit-methods-and-edit-view.md)
...
- [Начало работы с EF 5 с помощью MVC 4](getting-started-with-ef-5-using-mvc-4/index.md)
    ...
    - [Сортировка, фильтрация и разбиение на страницы](getting-started-with-ef-5-using-mvc-4/sorting-filtering-and-paging-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [Создание более сложной модели данных](getting-started-with-ef-5-using-mvc-4/creating-a-more-complex-data-model-for-an-asp-net-mvc-application.md)
    - [Чтение связанных данных](getting-started-with-ef-5-using-mvc-4/reading-related-data-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [Обновление связанных данных](getting-started-with-ef-5-using-mvc-4/updating-related-data-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [Обработка параллелизма](getting-started-with-ef-5-using-mvc-4/handling-concurrency-with-the-entity-framework-in-an-asp-net-mvc-application.md)
    - [Реализация наследования](getting-started-with-ef-5-using-mvc-4/implementing-inheritance-with-the-entity-framework-in-an-asp-net-mvc-application.md)
...
- [Начало работы с ASP.NET MVC 3](getting-started-with-aspnet-mvc3/index.md)
    ...
    - [Начало работы с ASP.NET MVC 3 (C#)](getting-started-with-aspnet-mvc3/cs/index.md)
        ...
        - [Доступ к данным модели из контроллера (C#)](getting-started-with-aspnet-mvc3/cs/accessing-your-models-data-from-a-controller.md)
        - [Изучение методов Edit и представления Edit (C#)](getting-started-with-aspnet-mvc3/cs/examining-the-edit-methods-and-edit-view.md)
    ...
    - [Начало работы с ASP.NET MVC 3 (VB.NET)](getting-started-with-aspnet-mvc3/vb/index.md)
        ...
        - [Доступ к данным модели из контроллера (VB)](getting-started-with-aspnet-mvc3/vb/accessing-your-models-data-from-a-controller.md)
        - [Изучение методов Edit и представления Edit (VB)](getting-started-with-aspnet-mvc3/vb/examining-the-edit-methods-and-edit-view.md)
