...
Затем откройте *\Views\Movies\Create.cshtml* файл и добавьте `Rating` поле, используя следующую разметку highlighed. Это отрисовывает текстовое поле, можно указать оценку, если создается новый фильм.
