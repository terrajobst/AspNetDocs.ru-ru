...
title: Проверка с помощью проверяющих элементов управления заметок к данным (C#) | Документация Майкрософт
author: microsoft
...
**Рис. 1**. Добавление ссылки на связыватель модели заметок к данным ([щелкните, чтобы просмотреть изображение с полным размером](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Эта строка кода регистрирует Атааннотатионсмоделбиндер в качестве связывателя модели по умолчанию для всего приложения ASP.NET MVC.
...
**Рис. 6**. использование проверяющих элементов управления с Entity Framework ([щелкните, чтобы просмотреть изображение с полным размером](validation-with-the-data-annotation-validators-cs/_static/image14.png))
