...
Для создания динамического содержимого в представлении можно использовать любой язык .NET. Как правило, для записи контроллеров и представлений C# используется либо Visual Basic .NET, либо.
...
[![диалоговом окне «Создание проекта»](asp-net-mvc-views-overview-vb/_static/image1.jpg)](asp-net-mvc-views-overview-vb/_static/image1.png)
