...
Контроллер — это класс (например, класс Visual Basic или C#). Пример приложения ASP.NET MVC включает контроллер с именем HomeController.cs, расположенный в папке Controllers. Содержимое файла HomeController.cs будет воспроизведено в листинге 2.
