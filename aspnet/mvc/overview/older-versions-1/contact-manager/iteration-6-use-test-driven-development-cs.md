...
---
# <a name="iteration-6--use-test-driven-development-c"></a>#6 итерации — использование разработки на основе тестированияC#()
...
Создайте новый модульный тест, щелкнув правой кнопкой мыши папку Controllers в проекте ContactManager. Tests, выбрав **Добавить, создать тест**и выбрав шаблон **модульного теста** (см. рис. 1). Назовите новый модульный тест GroupControllerTest.cs и нажмите кнопку **ОК** .

[![Добавление модульного теста Граупконтроллертест](iteration-6-use-test-driven-development-cs/_static/image1.jpg)](iteration-6-use-test-driven-development-cs/_static/image1.png)

**Рис. 01**. Добавление модульного теста Граупконтроллертест ([щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image2.png))
...
**Листинг 1. Контроллерс\граупконтроллертест.КС**
...
**Листинг 2. Контроллерс\граупконтроллер.КС**

[!code-csharp[Main](iteration-6-use-test-driven-development-cs/samples/sample2.cs)]

**Листинг 3. Моделс\грауп.КС**
...
[![успешно.](iteration-6-use-test-driven-development-cs/_static/image2.jpg)](iteration-6-use-test-driven-development-cs/_static/image3.png)

**Рис. 02**. успешное завершение! ([Щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image4.png))
...
**Листинг 4. Контроллерс\граупконтроллертест.КС**
...
**Листинг 5. Контроллерс\граупконтроллер.КС**
...
**Листинг 6. Контроллерс\граупконтроллертест.КС**
...
**Листинг 7 — Моделс\грауп.КС**

[!code-csharp[Main](iteration-6-use-test-driven-development-cs/samples/sample7.cs)]

**Листинг 8. Контроллерс\граупконтроллер.КС**
...
**Листинг 9. Контроллерс\граупконтроллер.КС**

[!code-csharp[Main](iteration-6-use-test-driven-development-cs/samples/sample9.cs)]

**Листинг 10 — Контроллерс\контактманажерсервице.КС**

[!code-csharp[Main](iteration-6-use-test-driven-development-cs/samples/sample10.cs)]

**Листинг 11 — Контроллерс\факеконтактманажеррепоситори.КС**
...
**Листинг 12 — Контроллерс\граупконтроллертест.КС**
...
[![создания связи таблицы базы данных](iteration-6-use-test-driven-development-cs/_static/image3.jpg)](iteration-6-use-test-driven-development-cs/_static/image5.png)

**Рис. 03**. Создание связи таблицы базы данных ([щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image6.png))

[![указание связей между таблицами](iteration-6-use-test-driven-development-cs/_static/image4.jpg)](iteration-6-use-test-driven-development-cs/_static/image7.png)

**Рис. 04**. Указание связей между таблицами ([щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image8.png))
...
**Рис. 05**. обновление модели Entity Framework из базы данных ([щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image10.png))
...
[![Entity Designer отображение группы и контакта](iteration-6-use-test-driven-development-cs/_static/image6.jpg)](iteration-6-use-test-driven-development-cs/_static/image11.png)

**Рис. 06**. Entity Designer отображения группы и контакта ([щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image12.png))
...
**Листинг 13. Моделс\ентитиконтактманажеррепоситори.КС**
...
**Рис. 07**. представление индекса группы ([щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image14.png))
...
[![представление индекса контактов](iteration-6-use-test-driven-development-cs/_static/image8.jpg)](iteration-6-use-test-driven-development-cs/_static/image15.png)

**Рис. 08**. представление индекса контактов ([щелкните, чтобы просмотреть изображение с полным размером](iteration-6-use-test-driven-development-cs/_static/image16.png))
