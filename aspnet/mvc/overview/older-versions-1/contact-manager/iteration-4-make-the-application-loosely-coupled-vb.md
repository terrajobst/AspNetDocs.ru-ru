...
В этой итерации мы воспользоваться преимуществами нескольких шаблонов дизайна программного обеспечения, которые мы можем выполнить рефакторинг наше приложение диспетчера контактов в приложении более разобщенными. После этого мы Contact Manager выиграла t все, что ничего не произошло до. Тем не менее мы сможем изменить приложение, проще в будущем.
...
**В листинге 1 - Models\IContactManagerRepository.vb**
...
**В листинге 5 - Models\IContactManagerService.vb**
