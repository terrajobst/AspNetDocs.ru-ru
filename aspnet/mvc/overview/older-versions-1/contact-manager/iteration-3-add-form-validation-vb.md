...
---
# <a name="iteration-3--add-form-validation-vb"></a>#3 итерации — Добавление проверки формы (VB)
...
[![диалоговом окне «Создание проекта»](iteration-3-add-form-validation-vb/_static/image1.jpg)](iteration-3-add-form-validation-vb/_static/image1.png)

**Рис. 01**. форма с проверкой ([щелкните, чтобы просмотреть изображение с полным размером](iteration-3-add-form-validation-vb/_static/image2.png))
...
**Листинг 2. Контроллерс\контактконтроллер.ВБ (создание с проверкой)**
