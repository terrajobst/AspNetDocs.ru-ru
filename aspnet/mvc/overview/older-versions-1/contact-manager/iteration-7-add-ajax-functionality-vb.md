...
title: '#7 итерации — Добавление функций AJAX (VB) | Документация Майкрософт'
author: microsoft
...
ms.locfileid: "78487002"
---
# <a name="iteration-7--add-ajax-functionality-vb"></a>#7 итерации — Добавление функций AJAX (VB)
...
**Рис. 01**. обновление только контактов ([щелкните, чтобы просмотреть изображение с полным размером](iteration-7-add-ajax-functionality-vb/_static/image2.png))
...
**Листинг 3 — Контроллерс\контактконтроллер.ВБ (метод Index)**
...
[![страницы подтверждения удаления](iteration-7-add-ajax-functionality-vb/_static/image2.jpg)](iteration-7-add-ajax-functionality-vb/_static/image3.png)

**Рис. 02**. страница подтверждения удаления ([щелкните, чтобы просмотреть изображение с полным размером](iteration-7-add-ajax-functionality-vb/_static/image4.png))
...
**Листинг 7 — Контроллерс\контактконтроллер.ВБ (Ажаксделете)**   
