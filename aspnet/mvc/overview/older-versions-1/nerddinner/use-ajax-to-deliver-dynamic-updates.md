...
Мы можем затем код шаблона представления, который мы добавили ранее, таким образом, вместо использования метода сообщение «Вы не зарегистрированы для данного события», мы вместо визуализации ссылки, при отправке обновления выполняет вызов AJAX, вызывает метод действия наших RSVPForEvent в нашем контроллере RSVP и RSVPs пользователя:
