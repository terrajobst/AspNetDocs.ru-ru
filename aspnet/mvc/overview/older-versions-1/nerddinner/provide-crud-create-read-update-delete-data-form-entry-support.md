...
Приведенный выше код выводит:  <em>&lt;span класс = «ошибка поле проверки»&gt;\*&lt;/span&gt;</em>вместо текст ошибки по умолчанию при наличии для ошибки Свойство EventDate.
