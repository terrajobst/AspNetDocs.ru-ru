...
Мы можем использовать. Поддержка NET регулярного выражения для реализации этой поддержки проверки телефона. Ниже приведен простой реализации PhoneValidator, мы можем добавить наш проект, который позволит нам добавить проверки шаблон регулярного выражения конкретной страны или региона:
