...
---
# <a name="5-minute-introduction-to-aspnet-mvc"></a>5 минут Введение в ASP.NET MVC

по [Скотт Hanselman](https://github.com/shanselman)

Скотт Hanselman предоставляет пять минут знакомства с ASP.NET MVC.

[&#9654;Смотреть видео (8 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/5-minute-introduction-to-aspnet-mvc)
